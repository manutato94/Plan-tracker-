// Datos del plan nutricional y de actividad física
...
// Estimación de gasto calórico por sesión (aproximado, solo para tendencia — no es medición clínica)
export const EXERCISE_KCAL = {
  "Gym": 350, "Running": 450, "Caminata": 150,
  "Bicicleta": 300, "Core": 150, "Movilidad": 80,
};
export const exerciseKcal = (name) => EXERCISE_KCAL[name] ?? 200;

// Guía del plan nutricional, día por día con cantidades
export const DAY_ACTIVITY = ["gym","run","gym","run","rest","gym","rest"];
export const DAY_NAMES = ["Lunes","Martes","Miércoles","Jueves","Viernes","Sábado","Domingo"];
export const DAY_SHORT = ["Lun","Mar","Mié","Jue","Vie","Sáb","Dom"];

// Comidas fijas repetidas durante la semana (desayuno/merienda)
