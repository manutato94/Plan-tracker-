...
import { MEAL_DEFS, OFFPLAN_SCALE, OFFPLAN_SCALE_LIGHT, offScaleFor, DESSERT_SCALE, MEALS_WITH_DESSERT, DEFAULT_WEEKLY_PLAN, DEFAULT_EXERCISES } from '../data/plan.js';
